...
<qgis version="2.14.11-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="uf_codigo">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="uf_valor">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="uf_codigo" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="1">
    <categories>
      <category render="true" symbol="0" value="si" label="si"/>
      <category render="true" symbol="1" value="s4" label="s4"/>
      <category render="true" symbol="2" value="s3" label="s3"/>
      <category render="true" symbol="3" value="s2" label="s2"/>
      <category render="true" symbol="4" value="s1" label="s1"/>
      <category render="true" symbol="5" value="s0" label="s0"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="163,161,223,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="labeling/namedStyle" value="BoldOblique"/>
  ...
  <displayfield>uf_codigo</displayfield>
  <label>0</label>
  <labelattributes>
