...
raster_path2 = "novembro2023.tif"

shapefile = "/var/py/volunclima/monitor/novembro2023/novembro23.shp"
...
m = Basemap(projection='cyl',llcrnrlat=-57.375,urcrnrlat=12.375,llcrnrlon=-81.375,urcrnrlon=-28.875,lat_ts=7,resolution='i')
()

#m.readshapefile('/var/py/volunclima/monitor/limites/Shp_Compilado_Geografica','map_shapes',drawbounds=3, color='black', default_encoding='latin-1')
m.drawcoastlines(linewidth=0.2)
m.drawcountries(linewidth=0.5)

# Dibujar la máscara del océano
